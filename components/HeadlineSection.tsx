...
const HeadlineSection: React.FC<HeadlineSectionProps> = ({
    ...
    return (
        <section className="relative py-32 md:py-48 px-6 bg-obsidian overflow-hidden">
            ...
            <motion.div
                ...
                className="absolute top-0 left-0 w-[100vw] h-[100vh] opacity-[0.08] pointer-events-none"
                style={{
            ...
            >
                <div className="flex flex-col items-center">
                    ...
                    <motion.div
                        ...
                        className="relative px-8 py-16 md:px-20 md:py-24 rounded-[3rem] border border-white/10 bg-white/[0.02] backdrop-blur-2xl overflow-hidden group"
                    >
                        {/* Inner Border Glow */}
                        ...
                        <div className="flex flex-col items-center text-center relative z-10">
                            ...
                            <div className="mb-10 space-y-2">
                                <motion.h2
                                    variants={itemVariants}
                                    className={`text-4xl md:text-6xl lg:text-7xl font-bold text-white leading-[1.1] tracking-tight ${lang === 'en' ? 'font-english' : 'font-heading'
                                        }`}
                                >
                                    {titleLine1}
                                </motion.h2>
                                <motion.h2
                                    variants={itemVariants}
                                    className={`text-4xl md:text-6xl lg:text-7xl font-bold leading-[1.1] tracking-tight ${lang === 'en' ? 'font-english' : 'font-heading'
                                        }`}
                            ...
                            >
                                ...
                                <p className={`text-silver/60 text-lg md:text-2xl leading-relaxed font-light ${lang === 'en' ? 'font-english tracking-wide' : 'font-body tracking-normal'
                                    }`}>
                                    {description}
                                </p>
                            </motion.div>
